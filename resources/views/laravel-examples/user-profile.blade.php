                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img height="80" width="80" src="{{ $user['profileImage'] }}" alt="..."
                ...
                <div class="card-body pt-4 p-3">
                    <form action="/user-profile" method="POST" role="form text-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="user.dob" class="form-control-label">{{ __('Birth date') }}</label>
                                    <div class="@error('user.dob') border border-danger rounded-3 @enderror">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control">
                                        <option {{ $user['gender'] === 'M' ? 'selected' : '' }} value="M">Male
                                        </option>
                                        <option {{ $user['gender'] === 'F' ? 'selected' : '' }} value="F">Female
                                        </option>
                                        <option {{ $user['gender'] === 'O' ? 'selected' : '' }}value="O">Other</option>
                                    </select>
                                </div>
                            </div>
                        </div>
